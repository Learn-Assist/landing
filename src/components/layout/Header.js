                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      <li>
                        <Link style={{ background: "rgba(255,255,255,0.85)" }} className="button button-light button-wide-mobile button-sm" to="/about-us/" onClick={this.closeMenu}>About us</Link>
                      </li>
                    </ul>
                    {!hideSignin &&
                      <ul
